...
const home = () => {
    ...
    const nearLists = itemData.filter((itemData) => arePointNear(itemData.start.lat, itemData.start.lng, itemData.start.radius) || arePointNear(itemData.end.lat, itemData.end.lng, itemData.end.radius));
    ...
    return (
       ...
       {isShowAllNear ?  
        <Grid container className={classes.topicHeaderStart}>
          ...
          <Typography className={classes.topicHeaderText} variant="h6" component="h2" >
            附近</Typography>
          </Grid> : 
          ...
          <Typography className={classes.topicHeaderText} variant="h6" component="h2" >
            ...
            <IconButton
                ...
                onClick={showAllNear}
                >
                    <NavigateNextOutlinedIcon /></IconButton></Grid> }
        </Container> : '' } 
        {!isShowAllHit ? 
        ...
        {(nearLists.map((item, index) => (
          ...
          {(!isShowAllNear) ?
          <Container>
            {isShowAllHit ?  <Grid container className={classes.topicHeaderStart}><IconButton
            color="inherit"
            aria-label="open drawer"
            onClick={backHome}
            >
          ...
          </Grid> : <Grid container className={classes.topicHeader}>
            <Typography className={classes.topicHeaderText} variant="h6" component="h2">
            熱門</Typography>
                <IconButton
                    color="inherit"
